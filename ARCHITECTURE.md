...
**pins** —
- `skills/live-spec-base/SKILL.md:72` (rules)
- `skills/live-spec-base/SKILL.md:121` (rule 6 checkpoint incl. INV-107 closing half)
- `skills/live-spec-base/SKILL.md:138` (rule 7 fence, INV-10/INV-11)
- `skills/live-spec-base/SKILL.md:251` (rules 15-16, door + work-kind + prototype)
- `skills/live-spec-base/SKILL.md:293` (rule 19, INV-23 — the workshop-noise law)
- `skills/live-spec-base/SKILL.md:314` (rule 20, INV-65 — skill search at setup and struggle)
- `skills/live-spec-base/SKILL.md:325` (rule 21, INV-84 — the clean-writer road)
- `skills/live-spec-base/SKILL.md:335` (rule 22, INV-98 — the convergence principle)
- `skills/live-spec-base/SKILL.md:349` (rule 23, INV-108 — the live-channel law)
- `skills/live-spec-base/references/settings-ladder.md:1` (ladder — the on-demand module beside the rulebook; `skills/live-spec-base/SKILL.md:597` carries the pointer to it)
...
- `skills/live-spec-base/SKILL.md:405` (rule 26, INV-136/INV-139 — a project kind declares design principles the verify pass runs; the per-kind table lives in this doc)
- `skills/live-spec-base/SKILL.md:413` (rule 27, INV-143 — the seat decides what it can decide, surfaces only what it cannot)
- `skills/live-spec-base/SKILL.md:422` (rule 28, INV-145 — the periodic full audit)
- `skills/live-spec-base/SKILL.md:520` (rule 32, INV-217 — the release-tier rule, minor/major/patch by the host cost)
- `skills/live-spec-base/SKILL.md:453` (rule 31, the earned-message law INV-183/INV-189 the named-reference machinery joins. The pair-travels register [E-35], the living-description heal [INV-240], and the earned auto-deposit [T-24] ride this rule's build, ROADMAP 424 [target]. The prover's station stands as their net until they ship, per [INV-150].)
- `skills/live-spec-base/SKILL.md:165` (rule 7's worker-restore sub-rule, INV-298 — the worker holds its own bytes, halts when it holds none, and the orchestrator owns recovery)
- `skills/live-spec-base/SKILL.md:567` (rule 35, INV-302 — the session extract, the closing step written by a fresh agent, and the opening decision sweep)
