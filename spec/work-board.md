...
8. The system *shall* draw the work board from that source file whenever the person asks for it, and *shall* keep the file current whether or not anybody is looking, since the board is where the context of every task is held between sessions. It *shall* stand at no published address. [INV-308, INV-67]
