# Worked examples the rules cite

The one home for the worked cases the base rulebook's rules point at. Each section below reads exactly
...
assets; a music project arrangement, stems and mix.

A codebase proves with unit tests and rendered or pixel
