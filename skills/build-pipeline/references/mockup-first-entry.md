# The mockup-first entry condition

The declared entry condition referenced from `SKILL.md`'s intake line (SPEC INV-43): where the condition
lives, what cancels it, and the worked case behind it. Every line below reads exactly as it read in the
body.
