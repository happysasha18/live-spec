...
Generated 2026-09-02 by `python3 scripts/measurements-table.py`. This table is the source of truth for where the work stands. Add `--html` to also build `docs/MEASUREMENTS.html`, the page to read it on — a transient render, swept once its reading closes (SPEC INV-286).
...
| 4 | `NEXT_STEPS.md` | open | — | n/m | n/m | n/m | 2.3 | 9 | 0 | n/m | n/m | 222 |
...
| 7 | `docs/spec-format.md` | open | — | n/m | n/m | n/m | 2.3 | 16 | 0 | n/m | n/m | 90 |
...
| 9 | `skills/live-spec-base/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 21 | 0 | n/m | n/m | 483 |
| 10 | `skills/build-pipeline/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 23 | 0 | n/m | n/m | 68 |
| 11 | `skills/communicator/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 25 | 0 | n/m | n/m | 499 |
| | **PLAN.md, read whenever a session picks up work** ||||||||||||
| 12 | `PLAN.md` | open | — | n/m | n/m | n/m | 2.3 | 28 | 0 | n/m | n/m | 2,702 |
...
| 13 | `skills/design-reviewer/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 30 | 0 | n/m | n/m | 432 |
| 14 | `skills/feedback-collector/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 32 | 0 | n/m | n/m | 140 |
| 15 | `skills/feedback-intake/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 35 | 0 | n/m | n/m | 103 |
| 16 | `skills/publish/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 37 | 0 | n/m | n/m | 173 |
| 17 | `skills/spec-author/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 39 | 0 | n/m | n/m | 275 |
| 18 | `skills/test-author/SKILL.md` | open | — | n/m | n/m | n/m | 2.3 | 42 | 0 | n/m | n/m | 229 |
| | **The specification family** ||||||||||||
| 19 | `PRODUCT_SPEC.md` | open | — | n/m | n/m | n/m | 2.3 | 44 | 0 | n/m | n/m | 316 |
| 20 | `ARCHITECTURE.md` | open | — | n/m | n/m | n/m | 2.3 | 46 | 0 | n/m | n/m | 69 |
| 21 | `TEST_MATRIX.md` | open | — | n/m | n/m | n/m | 2.3 | 49 | 0 | n/m | n/m | 161 |
| | **The documents a stranger meets on arrival** ||||||||||||
| 22 | `README.md` | open | — | n/m | n/m | n/m | 2.3 | 51 | 0 | n/m | n/m | 165 |
| 23 | `OVERVIEW.md` | open | — | n/m | n/m | n/m | 2.3 | 53 | 0 | n/m | n/m | 128 |
| 24 | `adopt/ADOPT.md` | open | — | n/m | n/m | n/m | 2.3 | 56 | 0 | n/m | n/m | 313 |
...
| bytes per criterion | not measured | no target |
| repeated pairs | 115 | falls or holds |
...
**requirements**, **criteria** — the specification's numbered requirements and their acceptance criteria, read through `guardrails/specformat.py`, the format's one shared parser. They are the inputs to the density column.

**bytes per criterion** — the bytes of the criterion lines divided by the number of criteria. It separates growth by addition from growth by wordiness, and it is a reading to compare against the last one, held against no bound: the gate that once held it reddened a delivery that cut whole requirements out of the document, because the criteria it cut ran shorter than the rest and the average rose. No target.
