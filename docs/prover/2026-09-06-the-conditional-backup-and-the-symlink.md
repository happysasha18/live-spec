...
- a71c439 The review record names its landing commit — the base this range is measured from (already on origin/main by the time the CI-only red below was found)
