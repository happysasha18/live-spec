...
Promise one, a reader gets through a document without stopping, measures 4,804 open writing findings across the live set today.

Promise two, the specification stops growing, measures PRODUCT_SPEC.md at 704,463 bytes against its 840,000-byte ceiling today.
...
| 80 | `docs/norms/work-board.provenance.md` | 5 | no | no | waiting |
| 81 | `templates/DECISIONS.template.md` | 5 | no | no | waiting |
| 82 | `templates/JOURNAL.template.md` | 5 | no | no | waiting |
| 83 | `templates/NEXT_STEPS.template.md` | 5 | no | no | waiting |
| 84 | `templates/PROBLEMS.template.md` | 5 | no | no | waiting |
| 85 | `skills/build-pipeline/references/minor-bump-gate.md` | 4 | no | no | waiting |
| 86 | `skills/communicator/references/words.md` | 4 | no | no | waiting |
| 87 | `templates/KILL_LIST.template.md` | 4 | no | no | waiting |
| 88 | `templates/profile.template.md` | 4 | no | no | waiting |
| 89 | `SURFACES.md` | 3 | no | no | waiting |
| 90 | `docs/MEASUREMENTS.md` | 3 | no | no | waiting |
| 91 | `docs/audits/2026-08-07-cost-map.md` | 3 | no | no | waiting |
| 92 | `docs/norms/onboarding-card-2026-07-10.provenance.md` | 3 | no | no | waiting |
| 93 | `scripts/grant-ask.md` | 3 | no | no | waiting |
| 94 | `skills/build-pipeline/references/request-kind-table.md` | 3 | no | no | waiting |
| 95 | `skills/communicator/README.md` | 3 | no | no | waiting |
| 96 | `skills/feedback-collector/README.md` | 3 | no | no | waiting |
| 97 | `editions/product-prover/PROVENANCE.md` | 2 | no | no | waiting |
...
| 102 | `editions/product-prover/README.md` | 1 | no | no | waiting |
| 103 | `editions/product-prover/SKILL.md` | 1 | no | no | waiting |
| 104 | `skills/live-spec-base/README.md` | 1 | no | no | waiting |
| 105 | `templates/ARCHITECTURE.template.md` | 1 | no | no | waiting |
| 106 | `PRODUCT_SPEC.index.md` | 0 | yes | no | waiting |
| 107 | `adopt/START.md` | 0 | yes | no | waiting |
| 108 | `docs/PROGRESS.md` | 0 | yes | no | waiting |
| 109 | `docs/audits/2026-08-07-number-rulings.md` | 0 | yes | no | waiting |
| 110 | `docs/plans/2026-07-28-two-goals-one-campaign.md` | 0 | yes | no | waiting |
| 111 | `docs/plans/2026-08-07-night-plan.md` | 0 | yes | no | waiting |
| 112 | `editions/product-prover/reference/stress-lenses.md` | 0 | yes | no | waiting |
| 113 | `skills/build-pipeline/references/project-setup.md` | 0 | yes | no | waiting |
| 114 | `skills/product-prover/README.md` | 0 | yes | no | waiting |
| 115 | `skills/text-audit/README.md` | 0 | yes | no | waiting |
| 116 | `skills/text-audit/references/human-prose-rules.md` | 0 | yes | no | waiting |
| 117 | `skills/text-audit/references/reader-prompt.md` | 0 | yes | no | waiting |
| 118 | `skills/text-audit/references/rewrite-meaning-check.md` | 0 | yes | no | waiting |
| 119 | `skills/text-audit/references/unprompted-reader-brief.md` | 0 | yes | no | waiting |
| 120 | `templates/PRODUCT_SPEC.template.md` | 0 | yes | no | waiting |
| 121 | `templates/ROADMAP.template.md` | 0 | yes | no | waiting |
| 122 | `templates/TEST_MATRIX.template.md` | 0 | yes | no | waiting |
...
| writing findings across all documents | 4,804 | 4,810 | 0 |
...
|---|---|---|---|---|
| bytes | 704,463 | 590,695 | 840,000 | under the ceiling |
| lines | 8,245 | not stated | not stated | set by the subdivision plan |
| words | 118,093 | not stated | not stated | set by the subdivision plan |
