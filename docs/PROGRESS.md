...
Promise two, the specification stops growing, measures PRODUCT_SPEC.md at 702,553 bytes against its 840,000-byte ceiling today.
...
|---|---|---|---|---|
| bytes | 702,553 | 590,695 | 840,000 | under the ceiling |
| lines | 8,229 | not stated | not stated | set by the subdivision plan |
| words | 117,766 | not stated | not stated | set by the subdivision plan |
| requirements | 310 | 282 | not stated | set by the subdivision plan |
| acceptance criteria | 1,778 | 1,372 | not stated | set by the subdivision plan |
| bytes per criterion | 184.8 | not stated | 207.2 | falls or holds |
| pairs stating one fact twice | 119 | 116 | 119 | falls or holds |
| share of the byte ceiling used | 83.6% | 70.3% | not stated | not stated |
