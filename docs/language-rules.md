...
**Derivation.** The 25/35-word caps follow plain-language readability practice: a general-reader sentence stays legible in one pass under about 25 words, and the acceptance-criterion's fixed, code-anchored shape earns the wider 35-word allowance.
