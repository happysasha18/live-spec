# `SKILL-REVIEW` — product-prover-pack, version homes move to 5.0.0

Skill: product-prover-pack. Date: 2026-08-14. Range: be4e4f0..c73c6e4.

Commit `6b1f0c4` ("Every tracked version home carries VERSION 5.0.0, and only the tracked ones")
is this skill's last change. Every changed line in `skills/product-prover-pack/` carries a version number;
