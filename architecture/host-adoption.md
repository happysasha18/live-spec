...
**pins** — `PRODUCT_SPEC.md:1`, `PLAN.md:191` (the task list), `JOURNAL.md:1`, `VERSION:1`, `scripts/sync-skills.sh:1` (E-23), `.live-spec/PROBLEMS.md:1` (E-24's dogfood instance; anchor owned by templates)
