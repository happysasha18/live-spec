...
- `skills/product-prover-pack/SKILL.md:150` (unwritten seams — the stress-lens family, INV-72)
- `.live-spec/profile.md:12` (gate cadence instance)
- `skills/product-prover-pack/SKILL.md:120` (restructure-merge gate — INV-114 delta-judging)
