...
- `skills/live-spec-base/SKILL.md:277` (rule 19, INV-23 — the workshop-noise law)
- `skills/live-spec-base/SKILL.md:298` (rule 20, INV-65 — skill search at setup and struggle)
- `skills/live-spec-base/SKILL.md:309` (rule 21, INV-84 — the clean-writer road)
