...
- `skills/live-spec-base/SKILL.md:242` (rule 16, prototype fence)
- `skills/live-spec-base/SKILL.md:258` (rule 22, INV-98 — the convergence principle)
...
- `skills/live-spec-base/SKILL.md:320` (rule 27, INV-143 — the seat decides what it can decide, surfaces only what it cannot)
