...
" """,
    ...
    # rather than at the whole plan. The arm that grepped PLAN.md for the literal 17,575 is gone,
    # 2026-08-28: the floor moves every time the pack grows a paragraph (17,676 by that evening),
    # so pinning a check to the figure made the check red on growth it was never watching for.
    # The probe measures the live floor at every start; that is where the number belongs.
